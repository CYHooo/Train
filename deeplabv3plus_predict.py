...
from src.utils.deeplabv3plus_predict import DeeplabV3
...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["paved_road", "unpaved_road"]
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "data/segmentation/deeplabv3+/Yangpyeong_01-03.v64-0427_02_road.voc/test/"
    dir_save_path   = "data/"
    #-------------------------------------------------------------------------#
